...
;(function ($, window, document, undefined) {
    ...
    var Tree = function (element, options) {
        ...
        return {
            ...
            searchOnlyShowResults: $.proxy(this.searchOnlyShowResults, this),
    ...
    */
    ...
    /**
     * 获取包含相关属性的树形结构数据，包含满足要求的所有父节点和所有子节点
     * @param data
     */
    ...
    var getRelateTreeData = function (data) {
        ...
        // if (data === null) {
        //     return this.getRelateTreeData(this.tree);
        // } else {
